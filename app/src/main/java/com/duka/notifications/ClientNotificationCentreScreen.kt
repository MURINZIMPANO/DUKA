...
@Composable
fun ClientNotificationCentreScreen(
    clientUserId: Long,
    ...
    val notifications by appNotificationRepository.getByUser(clientUserId).collectAsState(initial = emptyList())
        ...
        topBar = {
            TopAppBar(
                ...
                actions = {
                    TextButton(onClick = {
                        scope.launch {
                            appNotificationRepository.markAllAsRead(clientUserId)
                        }
                    }) {
