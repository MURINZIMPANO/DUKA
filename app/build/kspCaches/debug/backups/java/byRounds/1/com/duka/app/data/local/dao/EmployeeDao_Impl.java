...
public final class EmployeeDao_Impl implements EmployeeDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfUpdateLastSeenAt;
  ...
  public EmployeeDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfEmployee = new EntityInsertionAdapter<Employee>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `employees` (`id`,`businessId`,`userId`,`code`,`name`,`role`,`isActive`,`joinedAt`,`lastSeenAt`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(8, entity.getJoinedAt());
        if (entity.getLastSeenAt() == null) {
          statement.bindNull(9);
        } else {
          statement.bindLong(9, entity.getLastSeenAt());
        }
      }
    };
    this.__preparedStmtOfUpdateRole = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "UPDATE employees SET role = ? WHERE id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateActive = new SharedSQLiteStatement(__db) {
      ...
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE employees SET isActive = ? WHERE id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateLastSeenAt = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE employees SET lastSeenAt = ? WHERE id = ?";
        return _query;
      }
    };
  ...
  @Override
  public Object insert(final Employee employee, final Continuation<? super Long> $completion) {
  ...
  @Override
  public Object updateRole(final long employeeId, final String role,
  ...
  @Override
  public Object updateActive(final long employeeId, final boolean isActive,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
  ...
  @Override
  public Object updateLastSeenAt(final long employeeId, final long timestamp,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfUpdateLastSeenAt.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfUpdateLastSeenAt.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  @Override
  public Object deleteById(final long employeeId, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Flow<List<Employee>> getEmployeesByBusiness(final long businessId) {
    final String _sql = "SELECT * FROM employees WHERE businessId = ?";
      ...
      public List<Employee> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Employee(_tmpId,_tmpBusinessId,_tmpUserId,_tmpCode,_tmpName,_tmpRole,_tmpIsActive,_tmpJoinedAt,_tmpLastSeenAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public Object getEmployeesByBusinessOnce(final long businessId,
      final Continuation<? super List<Employee>> $completion) {
    final String _sql = "SELECT * FROM employees WHERE businessId = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, businessId);
  ...
  @Override
  public Object getByCode(final long businessId, final String code,
      final Continuation<? super Employee> $completion) {
    final String _sql = "SELECT * FROM employees WHERE businessId = ? AND code = ? LIMIT 1";
      ...
      public Employee call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new Employee(_tmpId,_tmpBusinessId,_tmpUserId,_tmpCode,_tmpName,_tmpRole,_tmpIsActive,_tmpJoinedAt,_tmpLastSeenAt);
          } else {
            _result = null;
          }
          return _result;
  ...
  public Object getActiveByCode(final String code,
      final Continuation<? super Employee> $completion) {
    final String _sql = "SELECT * FROM employees WHERE code = ? AND isActive = 1 LIMIT 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindString(_argIndex, code);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
  ...
  @Override
  public Object getByCodeAny(final String code, final Continuation<? super Employee> $completion) {
    final String _sql = "SELECT * FROM employees WHERE code = ? LIMIT 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindString(_argIndex, code);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
  ...
  @Override
  public Object getById(final long id, final Continuation<? super Employee> $completion) {
    final String _sql = "SELECT * FROM employees WHERE id = ? LIMIT 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
  ...
  @Override
  public Flow<Integer> getActiveEmployeeCount(final long businessId) {
    final String _sql = "SELECT COUNT(*) FROM employees WHERE businessId = ? AND isActive = 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, businessId);
