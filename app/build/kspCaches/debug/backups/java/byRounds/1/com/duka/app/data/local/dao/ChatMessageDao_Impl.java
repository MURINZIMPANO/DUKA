...
public final class ChatMessageDao_Impl implements ChatMessageDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfDeleteClientMessages;
  ...
  public ChatMessageDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfChatMessage = new EntityInsertionAdapter<ChatMessage>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `chat_messages` (`id`,`businessId`,`senderRole`,`senderLabel`,`text`,`timestamp`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(4, entity.getSenderLabel());
        statement.bindString(5, entity.getText());
        statement.bindLong(6, entity.getTimestamp());
      }
    };
    this.__preparedStmtOfDeleteClientMessages = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM chat_messages WHERE businessId = ? AND senderRole = 'client'";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object deleteClientMessages(final long businessId,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteClientMessages.acquire();
        int _argIndex = 1;
        _stmt.bindLong(_argIndex, businessId);
        try {
          __db.beginTransaction();
          try {
          ...
          __preparedStmtOfDeleteClientMessages.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  @Override
  public Flow<List<ChatMessage>> getMessagesByBusiness(final long businessId) {
    final String _sql = "SELECT * FROM chat_messages WHERE businessId = ? ORDER BY timestamp ASC";
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"chat_messages"}, new Callable<List<ChatMessage>>() {
      ...
      public List<ChatMessage> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfSenderLabel = CursorUtil.getColumnIndexOrThrow(_cursor, "senderLabel");
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpSenderLabel;
            _tmpSenderLabel = _cursor.getString(_cursorIndexOfSenderLabel);
            final String _tmpText;
            _tmpText = _cursor.getString(_cursorIndexOfText);
            final long _tmpTimestamp;
            _tmpTimestamp = _cursor.getLong(_cursorIndexOfTimestamp);
            _item = new ChatMessage(_tmpId,_tmpBusinessId,_tmpSenderRole,_tmpSenderLabel,_tmpText,_tmpTimestamp);
            _result.add(_item);
          }
          return _result;
        } finally {
