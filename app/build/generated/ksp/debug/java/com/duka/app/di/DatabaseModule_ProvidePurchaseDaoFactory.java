...
public final class DatabaseModule_ProvidePurchaseDaoFactory implements Factory<PurchaseDao> {
  ...
  public DatabaseModule_ProvidePurchaseDaoFactory(Provider<DukaDatabase> dbProvider) {
  ...
  public static DatabaseModule_ProvidePurchaseDaoFactory create(Provider<DukaDatabase> dbProvider) {
    return new DatabaseModule_ProvidePurchaseDaoFactory(dbProvider);
  }

  public static PurchaseDao providePurchaseDao(DukaDatabase db) {
