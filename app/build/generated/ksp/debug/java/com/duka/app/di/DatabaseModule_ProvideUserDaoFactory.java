...
public final class DatabaseModule_ProvideUserDaoFactory implements Factory<UserDao> {
  ...
  public DatabaseModule_ProvideUserDaoFactory(Provider<DukaDatabase> dbProvider) {
  ...
  public static DatabaseModule_ProvideUserDaoFactory create(Provider<DukaDatabase> dbProvider) {
    return new DatabaseModule_ProvideUserDaoFactory(dbProvider);
  }

  public static UserDao provideUserDao(DukaDatabase db) {
